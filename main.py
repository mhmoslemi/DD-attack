...
def main():
    ...
    parser.add_argument('--epoch_eval_train', type=int, default=600, help='epochs to train a model with synthetic data')
    ...
    parser.add_argument('--data_path', type=str, default='/home/mmoslem3/scratch/DD-attack/data', help='dataset path')
    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
            ...
            if it%25 == 0:
                print('%s iter = %04d, loss = %.6f' % (get_time(), it, loss_avg))

            if it % 100 == 1 or it == args.Iteration: # only record the final results
