...
#     --attack fc --restarts 1 \
#     --budget 0.01 --epsilon 0.0313725 --pgd_steps 150 --pgd_alpha 0.0039216 \
#     --lambda_margin 1 \
#     --num_surrogates 4 --surrogate_epochs 40 \
#     --num_targets 10 --num_victims 5 \
#     --victim_epochs 40 --victim_lr 0.1 --victim_bs 125 --victim_decay 35 \
#     --target_select random --seed 1 --surrogate_on_full_data --victim_pipelines standard
...
CUDA_VISIBLE_DEVICES=6 python main_IF.py \
    ...
    --surrogate_model ConvNet --model ConvNetBN \
    --class_pairs frog-airplane \
    --attack gradmatch --restarts 7 \
    --budget "$budget" --epsilon 0.0313725 --pgd_steps 75 --pgd_alpha 0.0039216 \
    --lambda_margin 1 \
    --num_surrogates 4 --surrogate_epochs 45 \
    --num_targets 10 --num_victims 5 \
    --victim_epochs 45 --victim_lr 0.1 --victim_bs 125 --victim_decay 30 --multilayer \
    --target_select random --seed 1 --surrogate_on_full_data --victim_pipelines standard \
    --random_select
